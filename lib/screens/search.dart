                  ...
                  return ( places != null) ? Column(
                      children: <Widget>[
                        Container(
                          ...
                          child: GoogleMap(
                            initialCameraPosition: CameraPosition(target: LatLng(currentPosition.latitude, currentPosition.longitude),zoom: 18.0),
                                    ...
                                    subtitle: Column(
                                        ...
                                        Consumer<double>(
                                          builder: (context, meters, widget) {
                                            return (meters != null) 
                                            ? Text('${places[index].vicinity} \u00b7 ${meters.round()} m.')
                                            : Container();
                                          }
                                        )
                                      ],
